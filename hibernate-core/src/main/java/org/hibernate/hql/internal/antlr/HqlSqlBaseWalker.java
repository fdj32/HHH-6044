...
public class HqlSqlBaseWalker extends antlr.TreeParser       implements HqlSqlTokenTypes
 {
	...
	protected AST generatePositionalParameter(AST delimiterNode, AST numberNode) throws SemanticException {
		return (AST)astFactory.make( (new ASTArray(1)).add(astFactory.create(PARAM,numberNode.getText())));
	}
...
public HqlSqlBaseWalker() {
	...
	public final void expr(AST _t,
		...
		try {      // for error handling
			...
			case MOD:
			{
				arithmeticExpr(_t, predicateNode );
				_t = _retTree;
				astFactory.addASTChild(currentAST, returnAST);
				expr_AST = (AST)currentAST.root;
				break;
	...
	public final void groupClause(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			do {
				if (_t==null) _t=ASTNULL;
				if (((_t.getType()==WEIRD_IDENT||_t.getType()==IDENT))&&( isGroupExpressionResultVariableRef( _t ) )) {
	...
	public final void selectExprList(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			do {
				...
				default:
				{
					if ( _cnt363>=1 ) { break _loop363; } else {throw new NoViableAltException(_t);}
				}
				}
				_cnt363++;
			} while (true);
		...
		try {      // for error handling
			...
			case COLL_SIZE:
			{
				...
				functionCall_AST = (AST)currentAST.root;
						...
						functionCall_AST = createCollectionSizeFunction( path_AST, inSelect );
						inSize=false;
		...
		try {      // for error handling
			...
			case PARAM:
			{
				...
				parameter_AST = (AST)currentAST.root;
						...
						parameter_AST = generatePositionalParameter( p, n );
		...
		try {      // for error handling
			...
			do {
				...
				if ((_t.getType()==JOIN||_t.getType()==FILTER_ENTITY||_t.getType()==RANGE)) {
					...
					if ( _cnt382>=1 ) { break _loop382; } else {throw new NoViableAltException(_t);}
				}
	...
	public final void comparisonExpr(AST _t) throws RecognitionException {
		...
		try {      // for error handling
			...
			case EQ:
			{
				...
				match(_t,EQ);
				_t = _t.getFirstChild();
				exprOrSubquery(_t, currentAST.root );
				_t = _retTree;
				astFactory.addASTChild(currentAST, returnAST);
				exprOrSubquery(_t, currentAST.root );
				_t = _retTree;
	...
	public final void caseExpr(AST _t,
		...
		try {      // for error handling
			...
			case CASE2:
			{
				simpleCaseExpression(_t, predicateNode );
				_t = _retTree;
				astFactory.addASTChild(currentAST, returnAST);
			...
			case CASE:
			{
				searchedCaseExpression(_t, predicateNode );
				_t = _retTree;
				astFactory.addASTChild(currentAST, returnAST);
				caseExpr_AST = (AST)currentAST.root;
				break;
	...
	public final void simpleCaseExpression(AST _t,
		 AST predicateNode 
	) throws RecognitionException {
		...
		try {      // for error handling
			...
			_t = _t.getFirstChild();
			inCase=true;
			expressionOrSubQuery(_t, currentAST.root );
			_t = _retTree;
			astFactory.addASTChild(currentAST, returnAST);
			{
			int _cnt458=0;
			...
			do {
				if (_t==null) _t=ASTNULL;
				if ((_t.getType()==WHEN)) {
					simpleCaseWhenClause(_t, currentAST.root, predicateNode );
					_t = _retTree;
					astFactory.addASTChild(currentAST, returnAST);
				}
				else {
	...
	public final void searchedCaseExpression(AST _t,
		 AST predicateNode 
	) throws RecognitionException {
		...
		try {      // for error handling
			...
			do {
				if (_t==null) _t=ASTNULL;
				if ((_t.getType()==WHEN)) {
					searchedCaseWhenClause(_t, predicateNode );
					_t = _retTree;
					astFactory.addASTChild(currentAST, returnAST);
				}
				else {
	...
	public final void expressionOrSubQuery(AST _t,
		 AST predicateNode 
	) throws RecognitionException {
	...
	public final void simpleCaseWhenClause(AST _t,
		 AST predicateNode, AST superPredicateNode 
	) throws RecognitionException {
		...
		try {      // for error handling
			...
			match(_t,WHEN);
			_t = _t.getFirstChild();
			expressionOrSubQuery(_t, predicateNode );
			_t = _retTree;
			astFactory.addASTChild(currentAST, returnAST);
			expressionOrSubQuery(_t, superPredicateNode );
			_t = _retTree;
			astFactory.addASTChild(currentAST, returnAST);
	...
	public final void elseClause(AST _t,
		 AST predicateNode 
	) throws RecognitionException {
	...
	public final void searchedCaseWhenClause(AST _t,
		 AST predicateNode 
	) throws RecognitionException {
	...
	public final void collectionPath(AST _t) throws RecognitionException {
		...
		AST collectionPath_AST_in = (_t == ASTNULL) ? null : (AST)_t;
		returnAST = null;
		ASTPair currentAST = new ASTPair();
		...
		try {      // for error handling
			...
			case IDENT:
			{
				qualifier = _t==ASTNULL ? null : (AST)_t;
				collectionPathQualifier(_t);
				_t = _retTree;
			...
			collectionPath_AST = (AST)currentAST.root;
					...
					resolve( qualifier_AST );
					collectionPath_AST = createCollectionPath( qualifier_AST, ref_AST );
	...
	public final void collectionPathQualifier(AST _t) throws RecognitionException {
		...
		AST collectionPathQualifier_AST_in = (_t == ASTNULL) ? null : (AST)_t;
		returnAST = null;
		ASTPair currentAST = new ASTPair();
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 72621093748248576L, 4467645557416145856L, 15L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 72761831236603952L, 4467645557483254720L, 15L, 0L, 0L, 0L};
		return data;
	}
