...
public HqlBaseLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("of", this), new Integer(68));
	literals.put(new ANTLRHashString("is", this), new Integer(31));
	literals.put(new ANTLRHashString("member", this), new Integer(66));
	...
	literals.put(new ANTLRHashString("by", this), new Integer(111));
	literals.put(new ANTLRHashString("nulls", this), new Integer(53));
	literals.put(new ANTLRHashString("all", this), new Integer(4));
	literals.put(new ANTLRHashString("order", this), new Integer(41));
	literals.put(new ANTLRHashString("both", this), new Integer(63));
	literals.put(new ANTLRHashString("some", this), new Integer(47));
	literals.put(new ANTLRHashString("properties", this), new Integer(43));
	literals.put(new ANTLRHashString("ascending", this), new Integer(112));
	literals.put(new ANTLRHashString("descending", this), new Integer(113));
	...
	literals.put(new ANTLRHashString("empty", this), new Integer(64));
	literals.put(new ANTLRHashString("sum", this), new Integer(48));
	literals.put(new ANTLRHashString("on", this), new Integer(61));
	...
	literals.put(new ANTLRHashString("versioned", this), new Integer(51));
	literals.put(new ANTLRHashString("in", this), new Integer(26));
	literals.put(new ANTLRHashString("avg", this), new Integer(9));
	literals.put(new ANTLRHashString("update", this), new Integer(50));
				...
				case '4':  case '5':  case '6':  case '7':
				{
					...
					do {
						if (((LA(1) >= '0' && LA(1) <= '7'))) {
							...
							if ( _cnt286>=1 ) { break _loop286; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
						}
